...
- In a terminal, navigate to `TelegramBotGuestTomsk.Core`

    ```bash
    # change into project folder
    cd TelegramBotGuestTomsk.Core
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `TelegramBotGuestTomsk.Core` folder
  - Select `TelegramBotGuestTomsk.Core.csproj` file
